...
using JobScraper.Web.Features.Scrape.Logic.Indeed;
using JobScraper.Web.Features.Scrape.Logic.Jjit;
using JobScraper.Web.Features.Scrape.Logic.NoFluffJobs;
using JobScraper.Web.Features.Scrape.Logic.Olx;
using JobScraper.Web.Features.Scrape.Logic.PracujPl;
using JobScraper.Web.Features.Scrape.Logic.RocketJobs;
